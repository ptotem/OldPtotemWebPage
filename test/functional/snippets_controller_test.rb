...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { description: @snippet.description, opta: @snippet.opta, optb: @snippet.optb, story_id: @snippet.story_id }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { description: @snippet.description, opta: @snippet.opta, optb: @snippet.optb, story_id: @snippet.story_id }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
